...
const TAG_BOX_ITEMS: TagItem[] = [
  ...
  { id: 'ace',            tag: 'Ace',             tagColor: '#F97316', rarity: 'Epic',      weight: 2    },
  { id: 'prodigy',        tag: 'Prodigy',         tagColor: '#EC4899', rarity: 'Epic',      weight: 2    },
  { id: 'mastermind',     tag: 'Mastermind',      tagColor: '#EAB308', rarity: 'Legendary', weight: 0.25 },
  { id: 'goat',           tag: 'GOAT',            tagColor: '#EAB308', rarity: 'Legendary', weight: 0.25 },
  { id: 'genius',         tag: 'Genius',          tagColor: '#EC4899', rarity: 'Mythic',    weight: 0.5  },
]

const NAME_COLOR_BOX_ITEMS: ColorItem[] = [
  { id: 'forest-green',  name: 'Forest Green',  value: '#15803D', rarity: 'Common',    weight: 10   },
  { id: 'navy-blue',     name: 'Navy Blue',      value: '#1D4ED8', rarity: 'Common',    weight: 10   },
  { id: 'dark-red',      name: 'Dark Red',       value: '#991B1B', rarity: 'Common',    weight: 10   },
  { id: 'slate-blue',    name: 'Slate Blue',     value: '#4338CA', rarity: 'Common',    weight: 10   },
  { id: 'teal',          name: 'Teal',           value: '#0F766E', rarity: 'Common',    weight: 10   },
  { id: 'bright-orange', name: 'Bright Orange',  value: '#EA580C', rarity: 'Uncommon',  weight: 8    },
  { id: 'violet',        name: 'Violet',         value: '#7C3AED', rarity: 'Uncommon',  weight: 8    },
  { id: 'cyan',          name: 'Cyan',           value: '#0891B2', rarity: 'Uncommon',  weight: 7    },
  { id: 'hot-pink',      name: 'Hot Pink',       value: '#DB2777', rarity: 'Rare',      weight: 6    },
  { id: 'gold',          name: 'Gold',           value: '#D97706', rarity: 'Rare',      weight: 6    },
  { id: 'lime-green',    name: 'Lime Green',     value: '#65A30D', rarity: 'Rare',      weight: 5    },
  { id: 'electric-blue', name: 'Electric Blue',  value: '#2563EB', rarity: 'Epic',      weight: 4    },
  { id: 'magenta',       name: 'Magenta',        value: '#C026D3', rarity: 'Epic',      weight: 3    },
  { id: 'pure-white',    name: 'Pure White',     value: '#F8FAFC', rarity: 'Legendary', weight: 1.99 },
  { id: 'black',         name: 'Black',          value: '#111111', rarity: 'Legendary', weight: 1    },
  { id: 'rainbow',       name: 'Rainbow RGB',    value: 'rainbow', rarity: 'Mythic',    weight: 0.01 },
]

const PFP_EFFECT_BOX_ITEMS: ColorItem[] = [
  { id: 'border-green',    name: 'Green Border',     value: 'border-green',   rarity: 'Common',    weight: 10   },
  { id: 'border-blue',     name: 'Blue Border',      value: 'border-blue',    rarity: 'Common',    weight: 10   },
  { id: 'border-red',      name: 'Red Border',       value: 'border-red',     rarity: 'Common',    weight: 10   },
  { id: 'border-navy',     name: 'Navy Border',      value: 'border-navy',    rarity: 'Common',    weight: 10   },
  { id: 'border-teal',     name: 'Teal Border',      value: 'border-teal',    rarity: 'Common',    weight: 10   },
  { id: 'border-orange',   name: 'Orange Border',    value: 'border-orange',  rarity: 'Uncommon',  weight: 8    },
  { id: 'border-violet',   name: 'Violet Border',    value: 'border-violet',  rarity: 'Uncommon',  weight: 8    },
  { id: 'border-cyan',     name: 'Cyan Border',      value: 'border-cyan',    rarity: 'Uncommon',  weight: 7    },
  { id: 'border-hotpink',  name: 'Hot Pink Border',  value: 'border-hotpink', rarity: 'Rare',      weight: 6    },
  { id: 'border-gold',     name: 'Gold Border',      value: 'border-gold',    rarity: 'Rare',      weight: 6    },
  { id: 'border-lime',     name: 'Lime Border',      value: 'border-lime',    rarity: 'Rare',      weight: 5    },
  { id: 'glow-pink',       name: 'Pink Glow',        value: 'glow-pink',      rarity: 'Epic',      weight: 4    },
  { id: 'glow-purple',     name: 'Purple Glow',      value: 'glow-purple',    rarity: 'Epic',      weight: 3    },
  { id: 'glow-gold',       name: 'Gold Glow',        value: 'glow-gold',      rarity: 'Legendary', weight: 1.99 },
  { id: 'frame-black',     name: 'Black Frame',      value: 'frame-black',    rarity: 'Legendary', weight: 1    },
